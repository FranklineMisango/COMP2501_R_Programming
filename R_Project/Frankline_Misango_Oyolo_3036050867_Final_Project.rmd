...
stop_words <- c("Ourengineersareworkingquicklytoresolvetheissue. Thankyouforyourpatience. Back to Mail Online home. back to the page you came from.")
...
for (ticker in monitored_tickers) {
  ...
  if (negative_count > 5) {
    ...
    cat(paste0("\nThe model finds that stock ", ticker, " is worth looking for to buy for the short term. Contact our brokers to buy.\n"))
  }
}
